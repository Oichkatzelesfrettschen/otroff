...
class TerminalTable {
  public:
    ...
    constexpr TerminalTable(
        ...
        const std::array<std::string_view, CODE_TABLE_SIZE> &code_table) noexcept
        : bset_{bset_bits}, breset_{breset_bits}, capabilities_{capabilities}, horizontal_resolution_{horizontal_resolution}, vertical_resolution_{vertical_resolution}, newline_spacing_{newline_spacing}, character_width_{character_width}, em_width_{em_width}, halfline_spacing_{halfline_spacing}, adjustment_spacing_{adjustment_spacing}, terminal_init_{terminal_init}, terminal_reset_{terminal_reset}, newline_seq_{newline_seq}, halfline_reverse_{halfline_reverse}, halfline_forward_{halfline_forward}, fullline_reverse_{fullline_reverse}, bold_on_{bold_on}, bold_off_{bold_off}, plot_on_{plot_on}, plot_off_{plot_off}, cursor_up_{cursor_up}, cursor_down_{cursor_down}, cursor_right_{cursor_right}, cursor_left_{cursor_left}, cursor_home_{cursor_home}, clear_screen_{clear_screen}, code_table_{code_table} {
