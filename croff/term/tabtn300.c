...
inline const uint32_t INCH = 240U;
 ...
 */
struct TermTab {
    uint32_t bset; // Bits to set on initialization
    uint32_t breset; // Bits to reset on initialization
    ...
    string_view twinit; // Terminal initialization string
    string_view twrest; // Terminal reset string
    string_view twnl; // Newline string
    string_view hlr; // Halfline reverse string
    string_view hlf; // Halfline forward string
    string_view flr; // Fullline reverse string
    string_view bdon; // Bold on string
    string_view bdoff; // Bold off string
    string_view ploton; // Plot mode on string
    string_view plotoff; // Plot mode off string
    string_view up; // Cursor up string
    string_view down; // Cursor down string
    string_view right; // Cursor right string
    string_view left; // Cursor left string
    array<string_view, 256 - 32> codetab; // Character code table
