...
void *setbrk(int incr) { static char buf[4096]; return buf; }
void flusho(void) {}
...
int main(void) {
    ...
    total++; passed += test_isLeapYear();
    total++; passed += test_cvtime();
    total++; passed += test_cnum();
    total++; passed += test_prstr();
    total++; passed += test_init1();
    total++; passed += test_control();
    total++; passed += test_getrq();
    total++; passed += test_getach();
    total++; passed += test_getname();
    total++; passed += test_getpn();
