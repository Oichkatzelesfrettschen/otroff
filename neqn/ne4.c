...
/*
 * Main driver for the neqn front-end.  This handles reading the input
 * equation source, invoking the parser and writing the resulting troff
...
/* avoid clash with stdio getc macro */
#undef getc
#define getc ngetc

#define SIGPIPE 13 /* troff has stopped reading */

/* simple flush helper for this standalone build */
#define flush(...) fflush(stdout)

/* default global size and font */
int gsize = 10;
int gfont = 'R';

/* input buffer for one line from the equation source */
char in[600];
