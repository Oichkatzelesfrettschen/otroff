...
/*
 * Attach subscript or superscript.
 */
...
/*
 * Change size; used during parsing.
 */
...
/*
 * Horizontal shift of expression.
 */
void shift(int p1) {
    yyval = p1;
    if (dbg)
